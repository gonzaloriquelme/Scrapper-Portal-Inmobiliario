...
my_url = 'https://www.portalinmobiliario.com/venta/departamento/metropolitana?tp=2&op=1&ca=1&ts=1&dd=0&dh=6&bd=0&bh=6&or=&mn=2&sf=1&sp=0&pi=uoxk3dm1qjrmqn4igorf05fl'
...
my_url = 'https://www.portalinmobiliario.com/venta/departamento/metropolitana?ca=1&ts=1&mn=2&or=&sf=1&sp=0&at=0&pg='

filename = "proyectosinmobrm.csv"
f = open(filename, "w")
...
for i in range(1,paginas+1):
	my_url ='https://www.portalinmobiliario.com/venta/departamento/metropolitana?ca=1&ts=1&mn=2&or=&sf=1&sp=0&at=0&pg='+str(i)
	uClient = uReq(my_url)
	page_html = uClient.read() 
	uClient.close()
	page_soup = soup(page_html, "html.parser")
